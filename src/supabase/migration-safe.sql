-- Safe Migration - handles existing triggers gracefully
...
-- Success message
SELECT 'Migration completed successfully! All missing columns, indexes, and triggers have been added.' as result;